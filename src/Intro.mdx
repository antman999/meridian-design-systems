...
## Design systems **-> [Figma](https://www.figma.com/file/vCRXNSDZGDM8Wy3b9ztHQS/Meridian-UI-Design-Systems?type=design&node-id=0-1&mode=design&t=5FCkLiPpdRJYHMxL-0)**

You can view the figma file here, this includes upcoming components, current designs and tokens. The current workflow is to implement here and translate to code.
